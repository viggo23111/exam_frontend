            ...
            <div>
                <svg className="waves" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                    ...
                    <g className="parallax">
                        <use xlinkHref="#gentle-wave" x="48" y="0" fill="#62242487"/>
                        <use xlinkHref="#gentle-wave" x="48" y="3" fill="#62242487"/>
                        <use xlinkHref="#gentle-wave" x="48" y="5" fill="#62242487"/>
                        <use xlinkHref="#gentle-wave" x="48" y="7" fill="#62242487"/>
                    </g>
                </svg>
            </div>
